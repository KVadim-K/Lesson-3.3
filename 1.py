...
while running:
    ...
    time_left = (start_ticks + timer_duration - current_ticks) / 1000
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if score % 10 == 0 and score > 0:
                start_ticks = current_ticks  # Перезапуск таймера
                if total_shots > 0:
    ...
    # Рисуем оставшееся время
    time_text = font.render(f"Время: {time_left:.2f}", True, (255, 255, 255))
